        ...
        <Grid item xs={12} md={12}>
          ...
          <div className={classes.demo}>
            <List style={{backgroundColor:'#D4D4D4'}}>
                ...
                <ListItem>
                  <ListItemText>
                      การติดตั้งสายเคเบิลตอนนอก/การทำ Pull Off
                  </ListItemText>
                  <ListItemSecondaryAction>
                    <IconButton edge="end" aria-label="delete">
                      <VisibilityIcon />
                ...
                <ListItem>
                  <ListItemText>
                      ภาพการติดตั้งกราวด์/การเชื่อมต่อกันของสายสะพาน
                  </ListItemText>
                  <ListItemSecondaryAction>
                    <IconButton edge="end" aria-label="delete">
                      <VisibilityIcon />
